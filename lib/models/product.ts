...
export const productSchema = z.object({
  ...
  // Make category optional to allow creating products without selecting a category
  ...
  images: z.array(z.string().min(1, 'Image URL cannot be empty')).max(10, 'Too many images').default([]),
